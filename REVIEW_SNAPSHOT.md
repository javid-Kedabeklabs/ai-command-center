...
- Local source checkpoint: `0d063ed` (`Record Agent Architecture release checkpoint`).
- Runtime data, audit logs, profiles, generated stores, credentials, local models, and user content are excluded.
- The authoritative release contract is `npm run verify:release` (29 gates, including eleven live browser journeys). Receipt: `e57c3ee01e4e7c81c2c4c2a319dfa1cf2d78f70ed3e50df10d0b8059f38c8d3d`.
- Host reload receipt: `69b60a38c967acfc7a8d719126b8f70414d09e411593f3131a23bc6e8ae435f6`.
