...
function loadReusableComponent(workflowRoot, componentId) {
  ...
  if (raw.governance?.locked) throw Object.assign(new Error('production workflow is locked; unlock it before changing component metadata'), { code: 'COMPONENT_LOCKED' })
  return raw
}
